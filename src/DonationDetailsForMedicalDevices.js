...
const DonationDetailsForMedicalDevices = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white shadow-md rounded px-8 py-6">
      <h2 className="text-lg font-semibold mb-6">Enter Medical Device Donation Details</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input type="file" id="image" onChange={handleImageChange} className="w-full bg-white border border-green-300 rounded px-3 py-2 focus:outline-none focus:border-green-500" accept="image/*" />
        </div>
        <div className="mb-4">
