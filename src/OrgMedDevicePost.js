...
const MedDeviceDetails = ({id, status}) => {
  
  const { data: medicalDevices, error, isPending } = useFetch('http://localhost:4000/medicalDevices/' + id);
  ...
  return (
      <div className="medical-device-details bg-white shadow overflow-hidden sm:rounded-lg mx-4 my-4 p-4 flex">
          ...
          {medicalDevices && (
              <>
                  <div className="w-full pr-4 flex flex-col">
                      ...
                      <button onClick={() => navigate('/org/medDevice')}
                  ...
                  <div className="w-2/5 pl-4 flex flex-col">
                      <div className="flex-grow">
                          <img src={medicalDevices.image} alt={medicalDevices.name}
